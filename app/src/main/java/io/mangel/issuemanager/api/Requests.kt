...
data class FileDownloadRequest(val authenticationToken: String, val constructionSite: ObjectMeta? = null, val map: ObjectMeta? = null, val issue: ObjectMeta? = null): AuthenticatedRequest(authenticationToken)
